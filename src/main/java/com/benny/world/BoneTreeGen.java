...
import net.minecraftforge.common.util.ForgeDirection;
	...
	public class BoneTreeGen 
	    ...
	    public BoneTreeGen(boolean p_i2027_1_)
	    {
	        this(p_i2027_1_, 4, 0, 0, false);
	    }

	    public BoneTreeGen(boolean doBlockNotify, int treeHeight, int wood, int leaves, boolean vines)
	    {
	        super(doBlockNotify);
	            ...
	            else
	            {
	                ...
	                if (isSoil && p_76484_4_ < 256 - l - 1)
	                {
	                        ...
	                        for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
	                        {
	                            ...
	                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
	                            {
	                                ...
	                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
	                                {
	                                    ...
	                                    {
	                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, Blocks.air, this.metaLeaves);
	                                    }
	                                }
	                            }
	                        }
	                    ...
	                    for (k1 = 0; k1 < l; ++k1)
	                    {
	                        ...
	                        {
	                            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, BasicBlocks.BPillar, this.metaWood);
